#!/usr/bin/env python3
# reduce_unsw_nb15.py - Reduces the UNSW-NB15 NetFlow dataset while preserving distribution
...
def reduce_dataset(input_file, output_file, reduction_rate=0.1, seed=42):
    """
    Reduces the UNSW-NB15 dataset while preserving attack distribution.
...
def main():
    parser = argparse.ArgumentParser(description='Reduce UNSW-NB15 NetFlow dataset size while preserving distribution')
    parser.add_argument('--input', default='/media/ssd/test/GNN/kaggle/input/nf-unsw-nb15-v2/NF-UNSW-NB15-v2.csv',
                        help='Path to input dataset file')
    parser.add_argument('--output', default='/media/ssd/test/standardized-datasets/netflow/nf_unsw_nb15_reduced.csv',
